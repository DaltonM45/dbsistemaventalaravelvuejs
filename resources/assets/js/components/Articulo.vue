            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button @click="abrilModal('articulo', 'registrar')" type="button" class="btn btn-secondary">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    <td>
                                        <button @click="abrilModal('articulo', 'actualizar', articulo)" type="button" class="btn btn-warning btn-sm" >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" v-model="precio_veta" class="form-control" placeholder="">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" @click="cerrarModal()">Cerrar</button>
                             <button v-if="tipoAccion==1" type="button" class="btn btn-primary" @click="registrarArticulo()">Guardar</button>
  ...
  export default {
      ...
      data() {
          return {
              ...
              stock:0,
              descripcion : '',
              arrayArticulo : [], // para almacenar la lista de categorias
    ...
    methods :{
        ...
        registrarArticulo(){
            ...
            if(this.idcategoria == 0){
               this.errorMostrarMjs.push("Seleccione una categoria");
            }
            if(!this.nombre){
               this.errorMostrarMjs.push("El nombre de la categoria es requerido!");
            } 
             if(!this.stock){
               this.errorMostrarMjs.push("Ponga numero de stock");
            } 
             if(!this.precio_veta){
               this.errorMostrarMjs.push("Ponga precio al articulo");
            } 
            let me = this;
                    ...
                    switch(accion){
                        ...
                        case 'actualizar':
                        {
                           // console.log(data);
                            ...
                            this.precio_veta =data['precio_venta'];
